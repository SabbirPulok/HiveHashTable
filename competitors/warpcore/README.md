...
cd hivehashtable/competitors/warpcore/
rm -rf build  # Important: clean old build cache
mkdir build && cd build
cmake .. -DWARPCORE_BUILD_BENCHMARKS=ON -DWARPCORE_BUILD_EXAMPLES=ON -DWARPCORE_BUILD_TESTS=ON
cmake --build .
